...
<strong>Notice:</strong> This page contains the student records for class <span className="font-semibold">EM101</span>.
    ...
    <div className="absolute right-0 mt-5 mr-3">
          ...
          <table className="min-w-full mt-24 border border-gray-300 rounded-md shadow-sm">
            ...
            <tbody className="bg-white divide-y divide-gray-300">
             {tasks.filter(t => t.class_name === 'EM101').map((t, index) => (
