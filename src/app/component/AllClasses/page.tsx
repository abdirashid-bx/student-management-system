...
const faculties = [
  {
    ...
    count: 2,
    students: "500+",
    Link: "Classes/classEng"
  },
  {
    title: "Medicine & Health Sciences",
    count: 3,
    students: "500+",
    Link: "Classes/Classmedicine"
  },
  {
    title: "Faculty of Education",
    count: 4,
    students: "500+",
   Link: "Classes/Classeduaction"
  },
  {
    title: "Veterinary & Agriculture",
    count: 5,
    students: "500+",
   Link: "Classes/ClassVeternary"
  },
  {
    title: "Computer & IT",
    count: 3,
    students: "500+",
    Link: "Classes/Classcom"
  },
  {
    title: "Faculty of Engineering",
    count: 6,
    students: "500+",
  Link: "Classes/ClasseEng"
  }
];

const classes = [
  { title: "CA231", hall: "Hall 1", students: 60 },
  { title: "CA232", hall: "Hall 2", students: 62 },
  { title: "CA233", hall: "Hall 3", students: 64 },
  { title: "CA234", hall: "Hall 4", students: 66 },
  { title: "CA235", hall: "Hall 5", students: 68 },
  { title: "CA236", hall: "Hall 6", students: 70 },
  { title: "CA237", hall: "Hall 7", students: 72 },
  { title: "CA238", hall: "Hall 8", students: 74 },
  { title: "CA239", hall: "Hall 9", students: 76 },
  { title: "CA240", hall: "Hall 10", students: 78 },
  { title: "CA241", hall: "Hall 11", students: 80 },
  { title: "CA242", hall: "Hall 12", students: 82 }
];
       ...
       <div className="bg-[rgb(249,249,249)] w-[300px] p-4 relative border-r-1 border-[#3C80FF]">
        ...
        {/* Main content */}
         ...
         onClick={()=>router.push(t.Link)}
          key={index} className="w-[85%] h-[180px] bg-[#F9F9F9] border border-[#3C80FF] rounded-md p-4 flex items-center gap-4 shadow-sm hover:shadow-md transition duration-300 justify-center cursor-pointer">
